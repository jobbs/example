...
public class CreatePmVO {
	...
	@ApiModelProperty(value = "물리서버 생성요청 정보", required = true)
	private List<CreatePmPmInfoVO> pmInfos; /*물리서버 생성요청 정보*/
	 ...
	 * @return the pmInfos
	 */
	public List<CreatePmPmInfoVO> getPmInfos() {
		return pmInfos;
	}
	/**
	 * @param pmInfos the pmInfos to set
	 */
	public void setPmInfos(List<CreatePmPmInfoVO> pmInfos) {
