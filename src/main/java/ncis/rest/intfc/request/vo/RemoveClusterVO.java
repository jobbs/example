...
public class RemoveClusterVO {
	...
	@ApiModelProperty(value = "클러스터 삭제요청정보", required = true)
	private List<RemoveClusterClusterInfoVO> clusterInfos; /*클러스터구성ID*/
	 ...
	 */
	public List<RemoveClusterClusterInfoVO> getClusterInfos() {
		return clusterInfos;
	}
	/**
	 * @param clusterInfos the clusterInfos to set
	 */
	public void setClusterInfos(List<RemoveClusterClusterInfoVO> clusterInfos) {
