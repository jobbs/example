...
/**
 * 자동확장이미지 Entity - 공통 Entity(등록/수정/삭제용)
 *
 * @author x
 */
...
public class RxImg {
	...
	/**
	 * @param imgUid the imgUid to set
	 */
	 ...
	 * @return the imgCapa
	 */
	public Integer getImgCapa() {
		return imgCapa;
	}
	/**
	 * @param imgCapa the imgCapa to set
	 */
	public void setImgCapa(Integer imgCapa) {
	...
	/**
	 * @param wrkPathNm the wrkPathNm to set
	 */
