 ...
 * @lastmodifier selim
 * @created 2016. 9. 5.
 * @lastmodified 2016. 9. 5.
 *
 * @history
 * -----------------------------------------------------------
 * Date         author         ver            Description
 * -----------------------------------------------------------
 * 2016. 9. 5.     selim         v1.0             최초생성
 *
 */
 ...
 * <pre></pre>
 *
 * @filename TermDicaryController.java
 *
 * @author 박봉춘
 * @lastmodifier 박봉춘
 * @created 2016. 10. 13.
 ...
 */
@Controller
@RequestMapping(value="/cpt/worddicary/term/")
public class TermDicaryController extends BaseController {
	 ...
	 * @return
	 */
	@RequestMapping(value="/insertTermDicary.do", method=RequestMethod.POST)
	 ...
	 * @return
	 */
	@RequestMapping(value="/selectTermDicary.do")
	 ...
	 * @return
	 */
	@RequestMapping(value="/updateTermDicary.do", method=RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value="/updateTermDicary.do", method=RequestMethod.POST)
	 ...
	 * @return
	 */
	@RequestMapping(value="/deleteTermDicary.do", method=RequestMethod.POST)
