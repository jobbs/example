...
/**
 * 가상서버 삭제 요청 결과 업데이트 VO
 *
 * @author 정해훈
 *
 */
public class RemoveVmResultVO {
    private String reqId;               /* 요청ID */
    private String vmId;                /* 가상서버구성ID */
    private String reqType;             /* 요청타입  'VM_DEL' */
    ...
    public String toString() {
        return "RemoveVmResultVO [reqId=" + reqId + ", vmId=" + vmId + ", reqType=" + reqType + ", modDate=" + modDate + ", modResult=" + modResult + ", errorMsg=" + errorMsg + ", totalStorageSize=" + totalStorageSize + "]";
    }
