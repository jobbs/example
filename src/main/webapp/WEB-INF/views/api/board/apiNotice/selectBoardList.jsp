		...
		<div class="box-body collapse in search-collapse">
			<div class="form-group">
				<div class="form-cell form-cell-50 col-lay-50">
					...
					<div class="cell-body">
						<form:input path="searchSbjct" title="제목" cssClass="form-control input-sm pull-right" />
					</div>
				</div>
					<div class="form-cell form-cell-50 col-lay-50">
					<div class="cell-title">
					...
					<div class="cell-body">
						<form:input path="searchContent" title="내용" cssClass="form-control input-sm pull-right" />
					</div>
				</div>
			</div>
		</div>
					...
					<c:forEach var="vo" items="${list }" varStatus="i">
						...
						<tr>
							...
							<td class="alignL ellipsis">
								<a href="<c:url value="${detailUrl }" />" title="<c:out value="${vo.sbjct}"/>"><c:out value="${vo.sbjct }" /></a>
							</td>
...
function goPage(page) {
	location.href = "selectBoardList.do?paginationInfo.currentPageNo=" + page + "&${listParam}";
}
