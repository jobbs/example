	...
	<div class="box">
		...
		<div class="box-body no-padding">
			<form:form commandName="answervo" enctype="multipart/form-data">
				<form:hidden path="parentSeq" value="${vo.boardSeq }" title="parentSeq"/>
				<form:hidden path="boardSeq" value="${answervo.boardSeq }" title="boardSeq"/>
				<table class="table table-horizon">
	...
	<div class="edit-btn-group">
		...
		<div class="pull-left btns">
			<button class="btn btn-sm btn-hover-gray" data-toggle="tooltip"
				title="" data-original-title="뒤로" onclick="goToUrl('${detailUrl}')">
