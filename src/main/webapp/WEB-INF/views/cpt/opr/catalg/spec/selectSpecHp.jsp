...
<form:form id="selectSpecHp" commandName="resultVo" action="updateSpec.do">
				...
				<table class="table table-horizon">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<form:input path="specNm" type="text" class="form-control essential" value="${resultVo.specNm }" maxlength="60" title="이름"/>
							</td>
						</tr>
						<tr>
				...
				<table class="table table-horizon">
					...
					<tbody>
					  	...
					  	<tr>
							...
							<td>
								<form:input path="entMaxVl" type="number" title="Entitlement 최대값" class="form-control essential onlyFloat" value="${resultVo.entMaxVl }" step="0.01" min="0.01" max="1.00" onblur="fn_checkData();" maxlength="4" />
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<form:input path="entDfltVl" type="number" title="Entitlement 기본값" class="form-control essential onlyFloat" value="${resultVo.entDfltVl }" step="0.01" min="0.01" max="1.00" onblur="fn_checkData();" maxlength="4" />
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table class="table table-horizon">
					...
					<tbody>
					  	...
					  	<tr>
							...
							<td>
								<form:input path="vcoreMaxVl" type="number" title="vCore 최대값" class="form-control essential onlyInteger" value="${resultVo.vcoreMaxVl }" step="1" min="1" max="128" onblur="fn_checkData();" maxlength="3" />
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<form:input path="vcoreDfltVl" type="number" title="vCore 기본값" class="form-control essential onlyInteger" value="${resultVo.vcoreDfltVl }" step="1" min="1" max="128" onblur="fn_checkData();" maxlength="3" />
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<form:input path="vcoreMinVl" type="number" title="vCore 최소값" class="form-control essential onlyInteger" value="${resultVo.vcoreMinVl }" step="1" min="1" max="128" onblur="fn_checkData();" maxlength="3" />
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table class="table table-horizon">
					...
					<tbody>
					 	<tr>
							...
							<td>
								<form:input path="memMaxVl" type="number" title="메모리 최대값" class="form-control essential onlyInteger" value="${resultVo.memMaxVl }" step="1" min="1" max="256" onblur="fn_checkData();" maxlength="3" />
							</td>
							<td>GB</td>
						</tr>
					</tbody>
				...
				<table class="table table-horizon">
					...
					<tbody>
						<tr>
							...
							<td>
								<form:input path="strgDfltVl" type="number" title="스토리지 기본값" class="form-control essential onlyInteger" value="${resultVo.strgDfltVl }" step="1" min="1" max="9999999" onblur="fn_checkData();" maxlength="7" />
							</td>
							<td>GB</td>
						</tr>
					</tbody>
...
<script type="text/javascript">
	...
	function doSubmit(result){
		...
		if(!fn_form_validation("selectSpecHp")){
			return;
		}
	...
	function fn_updateSpec(){
		...
		$('#selectSpecHp').ajaxSubmit(options);
	}
