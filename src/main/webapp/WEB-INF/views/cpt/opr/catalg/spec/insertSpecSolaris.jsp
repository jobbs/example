...
<c:url var="goInsertSpecSolaris" value="insertSpecSolaris.do">
	<c:forEach var="curParam" items="${param }">
		<c:param name="${curParam.key }" value="${curParam.value }"></c:param>
	</c:forEach>
</c:url>

<form:form id="insertSpecSolaris" commandName="vo" action="insertSpec.do">
...
<script type="text/javascript">
	...
	function doSubmit(result){
		...
		if(!fn_form_validation("insertSpecSolaris")){
			return;
		}
	...
	function fn_insertSpec(){
		...
		$('#insertSpecSolaris').ajaxSubmit(options);
	}
