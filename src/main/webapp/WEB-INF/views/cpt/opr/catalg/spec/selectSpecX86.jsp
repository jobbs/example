...
<form:form id="selectSpecX86" commandName="resultVo" action="updateSpec.do">
				...
				<table class="table table-horizon">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<form:input path="specNm" type="text" title="이름" class="form-control essential" value="${resultVo.specNm }" maxlength="60"/>
							</td>
						</tr>
						<tr>
...
<script type="text/javascript">
	...
	function doSubmit(result){
		...
		if(!fn_form_validation("selectSpecX86")){
			return;
		}
	...
	function fn_updateSpec(){
		...
		$('#selectSpecX86').ajaxSubmit(options);
	}
