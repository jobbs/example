...
<c:set var="menu" value="${menu:getCurrentMenuByCd(1) }" />
...
<nav class="navbar navbar-menus potal" id="navbar">

	<div class="navbar-logo">
		<a href="<c:url value="/" />"><b>Cloud</b>통합관리시스템<span>포털</span></a>
	</div>
...
<script>
$(function(){
	  $(".navbar-tap li.potal").addClass("active").siblings("li").removeClass("active");
});
</script>