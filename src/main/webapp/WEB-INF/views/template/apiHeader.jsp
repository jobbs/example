...
<c:set var="menu" value="${menu:getCurrentMenuByCd(97) }" />
...
<nav class="navbar navbar-menus api">

	<div class="navbar-logo">
		<a href="<c:url value="/api/" />"><b>Cloud</b>통합관리시스템<span>API Gateway</span></a>
	</div>
	<div class="navbar-left">
		<ul class="navbar-menu">
			...
			<li class="menu-all"><a href="javascript:void(0);" data-toggle="collapse" data-target=".navbar-menu-all">전체메뉴</a></li>
		</ul>
...
<script>
$(function(){
	  $(".navbar-tap li.api").addClass("active").siblings("li").removeClass("active");
});
</script>