			...
			<div class="box-body ">
				<div class="form-group">
		           <div class="form-cell form-cell-25">
			           ...
			           <div class="cell-body">
		             		<form:input path="clstrNm" cssClass="form-control input-sm" maxlength="" title="클러스터명" readonly="true"/>
		             	</div>
				   </div>
...
<script>
      ...
      function excelDown(){
    	 <c:if test="${vmList eq null or empty vmList }">
    		...
    		searchVo.action='<c:url value="selectClstrTimeResUseRtPXlsDown.do" />';
    		searchVo.submit();
    	}
      function fn_search(){
    	  searchVo.action='<c:url value="selectClstrTimeResUseRtP.do" />';
  		searchVo.submit();
      }
</script>