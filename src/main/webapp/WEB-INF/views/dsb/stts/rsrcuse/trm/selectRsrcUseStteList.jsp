						...
						<c:otherwise>
							<c:forEach var="vo" items="${list}" varStatus="ri">
								<tr>
									...
									<td class="alignR"><fmt:formatNumber value="${vo.openshift}" pattern="#,###" /></td>
...
<script type="text/javascript">
	...
	function fn_search() {
		...
		searchVo.action = '<c:url value="selectRsrcUseStteList.do" />';
		searchVo.submit();
	}
	...
	function fn_excelDown() {
		...
		searchVo.action = '<c:url value="selectRsrcUseStteXlsDown.do" />';
		searchVo.submit();
	}
</script>
