...
<div class="col-box-100 search-col">
	<div class="box list-box">
		...
		<div class="box-body no-padding list-body">
			<table class="table table-vertical table-bordered table-layout-fixed">
				<caption>vCore수 및 MEM(GB)용량별 가상서버수</caption>
				<colgroup>
					<col class="colAuto">
					<col class="colAuto">
					<col class="colAuto">
							...
							<c:forEach var="vo" items="${memCntList}" varStatus="ri">
								...
								<tr>
									<c:if test="${ri.count == 1 }">
										<td rowspan="10" class="alignL">vCore</td>
									</c:if>
	...
	<div class="box list-box">
		...
		<div class="box-body no-padding list-body">
			<table class="table table-vertical table-bordered">
				<caption>SAN(TB)용량별 가상서버수</caption>
				<colgroup>
					<col class="col12">
					<col class="col12">
					<col class="col12">
				...
				<thead>
					<tr>
						<th rowspan="3">가상서버 수</th>
						<th colspan="7">SAN(TB)</th>
					</tr>
					<tr>
	...
	<div class="box list-box">
		...
		<div class="box-body no-padding list-body">
			<table class="table table-vertical table-bordered">
				<caption>vCore수 및 MEM(GB)용량별 가상서버 비율</caption>
				<colgroup>
					<col class="colAuto">
					<col class="colAuto">
					<col class="colAuto">
	...
	<div class="box list-box">
		...
		<div class="box-body no-padding list-body">
			<table class="table table-vertical table-bordered">
				<caption>SAN(TB)용량별 가상서버 비율</caption>
				<colgroup>
					<col class="col12">
					<col class="col12">
					<col class="col12">
...
function fn_search() {
	...
	$("#frm").attr("action", "<c:url value='selectVmUsefulRngList.do'/>");
	$("#frm").submit();
	return false;
}
...
function fn_excelDown(userData){
	...
	$("#frm").attr("target", "_self");
	$("#frm").attr("action", "<c:url value='selectVmUsefulRngXlsDown.do'/>");
	$("#frm").submit();
	return false;
