...
<div class="box">
		...
		<div class="box-body no-padding">
				...
				<table class="table table-hover table-vertical" id="preDistrbListTable">
...
<script type="text/javascript">
	...
	function fn_selectPreDistrbList(){
		...
		$("#preDistrbVo").attr("action", contextPath+'/cmn/component/preDistrb/selectPreDistrbListViewP.do');
		$("#preDistrbVo").submit();
	}
