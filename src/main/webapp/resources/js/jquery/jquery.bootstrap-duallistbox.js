;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: '아이템 {0}',                                                              // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">검색결과</span> {0} from {1}',   // when not all of the options are visible due to the filter
      infoTextEmpty: '결과없음',                                                            // when there are no options present in the list
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        ' <div class="box1" style="padding-right:2px;">' +
        '   <label></label>' +
        '   <span class="info-container">' +
        '     <span class="info"><i class="fa fa-indent"></i></span>' +
        ...
        ' </div>' +
        ' <div class="box2" style="padding-left:2px;">' +
        '   <label></label>' +
        '   <span class="info-container">' +
        '     <span class="info"><i class="fa fa-outdent"></i></span>' +
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.box1, .box2').removeClass('col-box-50').addClass('span6');
        ...
        this.container.find('.box1, .box2').removeClass('span6').addClass('col-box-50');
