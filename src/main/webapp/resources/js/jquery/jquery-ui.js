...
$.extend( Datepicker.prototype, {
	...
	_attachments: function( input, inst ) {
		var showOn, buttonText, buttonImage, buttonHtml,
		...
		for ( row = 0; row < numMonths[ 0 ]; row++ ) {
			...
			for ( col = 0; col < numMonths[ 1 ]; col++ ) {
				...
				calender += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + cornerClass + "'>" +
					...
					"</div><table class='ui-datepicker-calendar'><caption>datepicker-calendar</caption><thead>" +
					"<tr>";
	...
	_generateMonthYearHeader: function( inst, drawMonth, drawYear, minDate, maxDate,
		...
		if ( secondary || !changeMonth ) {
			...
			monthHtml += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change' title='"+this._get( inst, "monthSuffix" )+"'>";
		...
		if ( !inst.yearshtml ) {
			...
			if ( secondary || !changeYear ) {
				...
				inst.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change' title='"+this._get( inst, "yearSuffix" )+"'>";
