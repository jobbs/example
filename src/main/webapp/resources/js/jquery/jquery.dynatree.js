...
//      if( !data.key ){
	...
	_getInnerHtml: function() {
		var tree = this.tree,
			...
			res = "",
			imageSrc;
		this.tree.logDebug("level=>"+level+":data=>"+data.gubun+":data.iconClass=>"+cache.tagNodeIcon);
...
//          noop(); // keep JSLint happy
			...
			if(data.gubun === "VM"){
				res +=  "<span class=' dynatree-virtualserver '></span>";
			}else if(data.gubun === "WX"){
				res +=  "<span class=' dynatree-podlist '></span>";
			}else{
