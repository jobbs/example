...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="<c:url value="/resources/seditor/fileUploader.do" />" method="post" enctype="multipart/form-data" onSubmit="return false;">
        <div id="pop_content2">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="#"><img src="../../img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="íì¸" id="btn_confirm"></a>
            <a href="#"><img src="../../img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="ì·¨ì" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
